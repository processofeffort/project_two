        ...
        <nav class="sidebar-main" style="margin-left: 30px;">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item active">
              <a href="admin_reviewcenter.php"><i class="mdi mdi-file-outline"></i>评论管理</a>
            </li>
            <li class="nav-item">
          ...
          <div class="topbar-left">
            <div class="lyear-aside-toggler">
              ...
              <span class="lyear-toggler-bar"></span>
			   ...
			   <span class="navbar-page-title">后台中心>评论管理</span>
          </div>
              ...
              <div class="card-body">
				<div class="edit-avatar">
				   <div class="form-group">
                    <input type="text" class="form-control" placeholder="请输入评论者ID搜索" name="username" id="key"/>
              	  </div>
...
function Load(key)
{
 ...
 $.ajax({
   ...
   success: function(data){
    ...
    for(var k in data)
     {
		 str+="<tr><td style='text-align: center;line-height:40px;'>"+data[k].s_tid+"</td><td style='text-align: center;line-height:40px;'>"+data[k].s_cid+"</td><td style='text-align: center;line-height:40px;'>"+data[k].title+"</td><td style='text-align: center;line-height:40px;'>"+data[k].s_content+"</td><td style='text-align: center;line-height:40px;'>"+data[k].s_datatime+"</td></tr>";
     }
      $("#nt").html(str);//把数据返回表格
    }
  });
