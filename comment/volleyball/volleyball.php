...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
 	...
 	<div class="collapse navbar-collapse" id="example-navbar-collapse">
    	<ul class="nav navbar-nav">
            ...
            <li class="active"><a href="volleyball.php">排球</a></li>
			...
			$href="../comment/volleyball/volleyball.php";
	...
	if(isset($_SESSION['name'])){
			...
			$href1="../comment/volleyball/volleyball.php";
      ...
      <div class="container">
          ...
          <div class="col-sm-12 col-md-12">
			...
			$result5=mysqli_query($conn,$sqlstr5); while($myrow5=mysqli_fetch_array($result5))echo "$myrow5[0]"?>">				
				<input type="text" name="asite" style="display:none" value="login.php?login=../comment/volleyball.php">
				<input type="text" name="usite" style="display:none" value="volleyball.php">				
				<input type="txet" name="ubelong" style="display:none" value="排球">
...
logs.onclick=function(){
	window.location="../../login/login.php?login=../comment/volleyball/volleyball.php";
}
</script>
