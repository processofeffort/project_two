...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
 	...
 	<div class="collapse navbar-collapse" id="example-navbar-collapse">
    	<ul class="nav navbar-nav">
            ...
            <li class="active"><a href="football.php">足球</a></li>
			...
			$href="../comment/football/football.php";
	...
	if(isset($_SESSION['name'])){
			...
			$href1="../comment/football/football.php";
      ...
      <div class="container">
          ...
          <div class="col-sm-12 col-md-12">
			...
			$result5=mysqli_query($conn,$sqlstr5); while($myrow5=mysqli_fetch_array($result5))echo "$myrow5[0]"?>">				
				<input type="text" name="asite" style="display:none" value="login.php?login=../comment/football.php">
				<input type="text" name="usite" style="display:none" value="football.php">				
				<input type="txet" name="ubelong" style="display:none" value="足球">	
...
logs.onclick=function(){
	window.location="../../login/login.php?login=../comment/football/football.php";
}
</script>
