...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
 	...
 	<div class="collapse navbar-collapse" id="example-navbar-collapse">
    	<ul class="nav navbar-nav">
            ...
            <li class="active"><a href="baseball.php">棒球</a></li>
			...
			$href="../comment/baseball/baseball.php";
	...
	if(isset($_SESSION['name'])){
			...
			$href1="../comment/baseball/baseball.php";
      ...
      <div class="container">
          ...
          <div class="col-sm-12 col-md-12">
			...
			$result5=mysqli_query($conn,$sqlstr5); while($myrow5=mysqli_fetch_array($result5))echo "$myrow5[0]"?>">				
				<input type="text" name="asite" style="display:none" value="login.php?login=../comment/baseball.php">
				<input type="text" name="usite" style="display:none" value="baseball.php">					
				<input type="txet" name="ubelong" style="display:none" value="棒球">
...
logs.onclick=function(){
	window.location="../../login/login.php?login=../comment/baseball/baseball.php";
}
</script>
