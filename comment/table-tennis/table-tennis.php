...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
 	...
 	<div class="collapse navbar-collapse" id="example-navbar-collapse">
    	<ul class="nav navbar-nav">
            ...
            <li class="active"><a href="table-tennis.php">乒乓球</a></li>
			...
			$href="../comment/table-tennis/table-tennis.php";
	...
	if(isset($_SESSION['name'])){
			...
			$href1="../comment/table-tennis/table-tennis.php";
      ...
      <div class="container">
          ...
          <div class="col-sm-12 col-md-12">
             <div class="panel panel-default" style="padding:7px;background-color:#CCC;">
                 ...
                 <em>></em>
                 <a href="table-tennis.php">乒乓球版块</a>
             </div>
            <!--内容区-->
            <div class="panel box-shadow radius" style="margin-top:20px;">
            <!--第一评论区-->
			<div class="tab-category">
				<a href=""><strong>乒乓球领域区</strong></a>
			...
			$result5=mysqli_query($conn,$sqlstr5); while($myrow5=mysqli_fetch_array($result5))echo "$myrow5[0]"?>">				
				<input type="text" name="asite" style="display:none" value="login.php?login=../comment/table-tennis.php">
				<input type="text" name="usite" style="display:none" value="table-tennis.php">				
				<input type="txet" name="ubelong" style="display:none" value="乒乓球">
...
logs.onclick=function(){
	window.location="../../login/login.php?login=../comment/table-tennis/table-tennis.php";
}
</script>
