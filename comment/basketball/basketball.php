...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
 	...
 	<div class="collapse navbar-collapse" id="example-navbar-collapse">
    	<ul class="nav navbar-nav">
        	...
        	<li class="active"><a href="basketball.php">篮球</a></li>
			...
			$href="../comment/basketball/basketball.php";
	...
	if(isset($_SESSION['name'])){
			...
			$href1="../comment/basketball/basketball.php";
      ...
      <div class="container">
          ...
          <div class="col-sm-12 col-md-12">
			...
			$result5=mysqli_query($conn,$sqlstr5); while($myrow5=mysqli_fetch_array($result5))echo "$myrow5[0]"?>">
				<input type="text" name="asite" style="display:none" value="login.php?login=../comment/basketball.php">
				<input type="text" name="usite" style="display:none" value="basketball.php">
				<input type="txet" name="ubelong" style="display:none" value="篮球">
...
//					    echo "<textarea class='form-control' rows='5' name='txt' id='searchvalue'></textarea>";
						...
						echo "<div class='form-group'>";
						echo "<textarea class='form-control' rows='5' name='txt' disabled placeholder='用户封禁中'></textarea>";
						echo "</div>";
						echo "<input type='button' class='btn btn-primary' style='margin:0 10px 10px;' value='禁止' disabled/>";		}
				  }
				  else{
					echo "<div class='form-group'>";
...
logs.onclick=function(){
	window.location="../login/login.php?login=../comment/basketball.php";
}
</script>
...
<script>
var bbc = document.getElementById("bbq");
	bbc.onclick=function(){
		var abc = document.getElementsByClassName("simditor-body")[0];
		var abctxt = abc.innerHTML;
		var abcd =document.getElementById("editor");
		abcd.value=abctxt;
	}
</script>
</body>
