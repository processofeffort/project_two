  ...
  mysqli_query($conn,"set names utf8");
    if(isset($_POST['sub1'])){
		...
		$wtitle=$_POST['rtitle'];
  		...
  		$sqlstr1="insert into scontent(s_ccid,s_tid,s_cid,s_ruser,s_reuser,s_own,s_ocontent,s_content,s_datatime,s_call,s_cup,s_cdown,s_cclasses,s_cif) values('".$cid."','".$userid."','".$contentid."','".$cuser."','".$cruser."',3,'".$csecondtxt."','".$ctext."','".$wdatatime."',0,0,0,'".$ssite."',1)";
