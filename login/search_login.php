...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="navbar-header">
     ...
     <div class="form row">
            ...
            <h3>找回密码</h3>
			<h4 id="ha">第一步骤：账号验证</h4>
            <div class="col-md-9" name="gop">
            	<div class="form-group" style="margin-bottom:15px">
                <i></i>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    <input class="form-control required" type="text" placeholder="请输入你的账号" id="username" name="username" autofocus="autofocus" maxlength="20" onblur="checkUserid()"/>
					 <span id="sp10"></span>
                </div>
                </div>
                <div class="col-md-9" name="gop">
...
<script type="text/javascript" src="yanzheng1.js"></script>
<script>
document.getElementById("btn").addEventListener("click",function(){
	var key = $("#username").val();
	window.location.href="search_logintwo.php?account="+key+"";
},false);
</script>
<script>
setInterval(function(){	
if(document.getElementById("username").value&&document.getElementById("sp12").style.color=="green"){
